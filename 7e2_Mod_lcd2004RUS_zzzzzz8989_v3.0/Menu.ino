void Menu()
{
   ...
   if (!Joy_Z_flag && !Joy_X_flag)
   {
      ...
      if (Mode_New != Mode_Old)
      {
         ...
         else if (Mode_New == B11111101) {Switch_Tachometr(); Beep();}
...
void Key_Up_Pressed()
{
  if (!button_up_flag)
  {
     switch (Mode)
     {
        ...
        if (SelectMenu == 1 && !Joy_Z_flag && !Joy_X_flag)
           {
           if      (Ap < 10)  {Ap = Ap +  5;  Beep();}
           else if (Ap < 500) {Ap = Ap + 10;  Beep();}
           else if (Ap < 900) {Ap = Ap + 50;  Beep();}
           }
